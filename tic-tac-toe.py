...
class TicTacToeGame:
    ...
    def playturn(self):
        ...
        if self.turn == 1:
            ...
            self.previously_played.append(str(str(move[0]) + "," + str(move[1])))
            self.gameboard.entries[move[0]][move[1]] = 2
            self.turn = 1
            print("Previously Played: ", self.previously_played)
